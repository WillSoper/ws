...
namespace AdventOfCode2018
{
    class Program
    {
        ...
        {
            Day7Solution day7pt1 = new Day7Solution();
            var contentDay7 = File.ReadAllLines("inputs/day7.txt");
            Console.WriteLine("Day 7 pt1 answer: {0}", day7pt1.getSolutionPt1(contentDay7));
